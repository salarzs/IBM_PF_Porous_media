...
call MPI_TYPE_VECTOR((j1+1+10)*(k1+1+10),1,(i1+1+10),MPI_INTEGER,xhalo2,error)
call MPI_TYPE_COMMIT(xhalo2,error)
call MPI_TYPE_VECTOR((k1+1+10),(i1+1+10),(i1+1+10)*(j1+1+10),MPI_INTEGER,yhalo2,error)
call MPI_TYPE_COMMIT(yhalo2,error)

call MPI_TYPE_VECTOR((j1+1+10)*(k1+1+10),1,(i1+1+10),MPI_REAL8,xhalo3,error)
call MPI_TYPE_COMMIT(xhalo3,error)
call MPI_TYPE_VECTOR((k1+1+10),(i1+1+10),(i1+1+10)*(j1+1+10),MPI_REAL8,yhalo3,error)
